...
harvestSommelier1=$(cast send $YEARN_ST_ETH_STRATEGY --private-key $KEEPER1_PRIVATE_KEY "harvest(uint256,uint256,uint256,address)" 0 0 0 $VAULT)
harvestSommelier2=$(cast send $YEARN_ST_ETH_DEPOSIT_ST_ETH_STRATEGY --private-key $KEEPER1_PRIVATE_KEY "harvest(uint256,uint256,uint256,address)" 0 0 0 $VAULT)
