...
contract MockERC777 is Context, IERC777, IERC20 {
    ...
    constructor(string memory name_, string memory symbol_, address[] memory defaultOperators_, address _attacker) {
        _name = name_;
        _symbol = symbol_;

        _defaultOperatorsArray = defaultOperators_;
        attacker = _attacker;
        _mint(_attacker, 1e18, "", "");
    }
    ...
    function _callTokensToSend(address, address, address, uint256, bytes memory, bytes memory) private {
