...
import {
    ConvexCrvUSDSusdCollateralStrategy,
    SafeTransferLib
} from "src/strategies/mainnet/USDC/convex/ConvexCrvUSDSusdCollateralStrategy.sol";

contract ConvexCrvUSDSusdCollateralStrategyWrapper is ConvexCrvUSDSusdCollateralStrategy {
