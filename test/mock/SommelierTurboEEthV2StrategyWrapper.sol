...
import {
    ...
    SafeTransferLib
} from "src/strategies/mainnet/WETH/sommelier/SommelierTurboEEthV2Strategy.sol";

contract SommelierTurboEEthV2StrategyWrapper is SommelierTurboEEthV2Strategy {
