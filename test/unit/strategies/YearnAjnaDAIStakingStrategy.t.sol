...
contract YearnAjnaDAIStakingStrategyTest is BaseTest, StrategyEvents {
    ...
    function setUp() public {
        ...
        /// Deploy MaxApyVault
        vaultDeployment = new MaxApyVault(DAI_MAINNET, "MaxApyWETHVault", "maxWETH", TREASURY);
    ...
    function testYearnAjnaDAI_Staking__Initialization() public {
        ...
        /// Deploy MaxApyVault
        MaxApyVault _vault = new MaxApyVault(DAI_MAINNET, "MaxApyWETHVault", "maxWETH", TREASURY);
        /// Deploy transparent upgradeable proxy admin
