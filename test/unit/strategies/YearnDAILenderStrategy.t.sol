...
contract YearnDAILenderStrategyTest is BaseTest, StrategyEvents {
    ////////////////////////////////////////////////////////////////
    ///                    CONSTANTS                             ///
    ////////////////////////////////////////////////////////////////
    address public constant YVAULT_DAI_POLYGON = 0xf4F9d5697341B4C9B0Cc8151413e05A90f7dc24F;
    ...
    YearnDAILenderStrategyWrapper public implementation;
    ...
    function setUp() public {
        ...
        vaultDeployment = new MaxApyVaultV2(DAI_POLYGON, "MaxApyDAIVault", "maxDAI", TREASURY);

        vault = IMaxApyVaultV2(address(vaultDeployment));
        /// Deploy transparent upgradeable proxy admin
        proxyAdmin = new ProxyAdmin();
        /// Deploy strategy implementation
        implementation = new YearnDAILenderStrategyWrapper();
    ...
    function testYearnDAILender__Initialization() public {
        /// *************** Yearn Strategy initialization *************** ///
        /// Deploy MaxApyVaultV2
        MaxApyVaultV2 _vault = new MaxApyVaultV2(DAI_POLYGON, "MaxApyDAIVault", "maxDAI", TREASURY);
        /// Deploy transparent upgradeable proxy admin
        ProxyAdmin _proxyAdmin = new ProxyAdmin();
        /// Deploy strategy implementation
        YearnDAILenderStrategyWrapper _implementation = new YearnDAILenderStrategyWrapper();
        ...
        /// Assert underlying asset is set to DAI
        ...
        /// Assert underlying asset is set to YVAULT_DAI_POLYGON
    ...
    function testYearnDAILender__SetEmergencyExit() public {
    ...
    ////////////////////////////////////////////////////////////////
    function testYearnDAILender__SetMinSingleTrade() public {
        /// Test unauthorized access with a user without privileges
        vm.stopPrank();
        vm.startPrank(users.bob);
        vm.expectRevert(abi.encodeWithSignature("Unauthorized()"));
    ...
    ///                     TEST isActive()                      ///
    ////////////////////////////////////////////////////////////////
    function testYearnDAILender__IsActive() public {
    ...
    ///                    TEST setStrategist()                  ///
    ////////////////////////////////////////////////////////////////
    function testYearnDAILender__SetStrategist() public {
        // Negatives
        vm.startPrank(users.bob);
        vm.expectRevert(abi.encodeWithSignature("Unauthorized()"));
    ...
    ///                      TEST slippage                       ///
    ////////////////////////////////////////////////////////////////
    function testYearnDAILender__InvestmentSlippage() public {
    ...
    ///                   TEST _prepareReturn()                  ///
    ////////////////////////////////////////////////////////////////W
    function testYearnDAILender__PrepareReturn() public {
        /// ⭕️ SCENARIO 1:
        /// 1. Initial State:
    ...
    ////////////////////////////////////////////////////////////////
    function testYearnDAILender__AdjustPosition() public {
    ...
    ///                   TEST _invest()                         ///
    ////////////////////////////////////////////////////////////////
    function testYearnDAILender__Invest() public {
    ...
    ///                   TEST _divest()                         ///
    ////////////////////////////////////////////////////////////////
    function testYearnDAILender__Divest() public {
        /// Perform 10 ETH investment
        deal({token: DAI_POLYGON, to: address(strategy), give: 10 ether});
        uint256 expectedShares = strategy.sharesForAmount(10 ether);
        strategy.invest(10 ether, 0);
    ...
    ////////////////////////////////////////////////////////////////
    function testYearnDAILender__LiquidatePosition() public {
    ...
    ////////////////////////////////////////////////////////////////
    function testYearnDAILender__LiquidateAllPositions() public {
        /// Perform 10 ETH investment
        deal({token: DAI_POLYGON, to: address(strategy), give: 10 ether});
        uint256 expectedShares = strategy.sharesForAmount(10 ether);
        strategy.invest(10 ether, 0);
    ...
    ///                     TEST harvest()                       ///
    ////////////////////////////////////////////////////////////////
    function testYearnDAILender__Harvest_Negatives() public {
        vault.addStrategy(address(strategy), 4000, type(uint72).max, 0, 0);
    ...
    function testYearnDAILender__Harvest() public {
        ...
        assertEq(IERC20(DAI_POLYGON).balanceOf(address(vault)), 60 ether + 4.523 ether);
        /// the strategy reinvests the profit partially          // 5.477 ether
        shares = strategy.sharesForAmount(5.477 ether);
        assertEq(IERC20(YVAULT_DAI_POLYGON).balanceOf(address(strategy)), expectedStrategyShareBalance + shares, "3");
        ...
        vm.expectEmit();
        emit Harvested(49.999999999999999999 ether, 0, 0, 0);
    ...
    ////////////////////////////////////////////////////////////////
    function testYearnDAILender__PreviewLiquidate() public {
        vault.addStrategy(address(strategy), 4000, type(uint72).max, 0, 0);
        vault.deposit(100 ether, users.alice);
        vm.startPrank(users.keeper);
        strategy.harvest(0, 0, 0, address(0));
    ...
    /*     function testYearnDAILender__PreviewLiquidate__FUZZY(uint256 amount) public {
        vm.assume(amount > 1e16 && amount <= 1000 ether);
        vault.addStrategy(address(strategy), 10_000, type(uint72).max, 0, 0);
        deal(DAI_POLYGON, users.alice, amount * 2);
    ...
    ////////////////////////////////////////////////////////////////
    function testYearnDAILender__PreviewLiquidateExact() public {
        vault.addStrategy(address(strategy), 4000, type(uint72).max, 0, 0);
        vault.deposit(100 ether, users.alice);
        vm.startPrank(users.keeper);
        strategy.harvest(0, 0, 0, address(0));
    ...
    /*     function testYearnDAILender__PreviewLiquidateExact__FUZZY(uint256 amount) public {
        vm.assume(amount > 1e16 && amount <= 1000 ether);
        vault.addStrategy(address(strategy), 10_000, type(uint72).max, 0, 0);
        deal(DAI_POLYGON, users.alice, amount * 2);
        vault.deposit(amount * 2,users.alice);       
    ...
    ////////////////////////////////////////////////////////////////
    function testYearnDAILender__maxLiquidateExact() public {
    ...
    /* 
    function testYearnDAILender__maxLiquidateExact__FUZZY(uint256 amount) public {
        vm.assume(amount > 1e16 && amount <= 1000 ether);
        vault.addStrategy(address(strategy), 10_000, type(uint72).max, 0, 0);
        deal(DAI_POLYGON, users.alice, amount * 2);
        vault.deposit(amount * 2,users.alice);       
    ...
    */
    ...
    function testYearnDAILender__MaxLiquidate() public {
        vault.addStrategy(address(strategy), 9000, type(uint72).max, 0, 0);
        vault.deposit(100 ether, users.alice);
        vm.startPrank(users.keeper);
        strategy.harvest(0, 0, 0, address(0));
    ...
    /*     function testYearnDAILender__MaxLiquidate__FUZZY(uint256 amount) public {
        vm.assume(amount > 1e16 && amount <= 1000 ether);
        vault.addStrategy(address(strategy), 10_000, type(uint72).max, 0, 0);
        deal(DAI_POLYGON, users.alice, amount * 2);
        vault.deposit(amount * 2,users.alice);
