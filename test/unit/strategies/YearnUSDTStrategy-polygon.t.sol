...
contract YearnUSDTStrategyTest is BaseTest, StrategyEvents {
    ...
    function setUp() public {
        ...
        /// Deploy MaxApyVault
        vaultDeployment = new MaxApyVault(address(this), USDT_POLYGON, "MaxApyUSDTVault", "maxUSDT", TREASURY);
    ...
    function testYearnUSDT__Initialization() public {
        ...
        /// Deploy MaxApyVault
        MaxApyVault _vault = new MaxApyVault(address(this), USDT_POLYGON, "MaxApyUSDTVault", "maxUSDT", TREASURY);
        /// Deploy transparent upgradeable proxy admin
